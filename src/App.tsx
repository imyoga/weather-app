...
const WeatherApp: React.FC = () => {
	...
	useEffect(() => {
		...
		const defaultCoordinates: Coordinates = { lat: 40.7128, lon: -74.006 }
	...
	return (
		<Box sx={{ minHeight: '100vh', backgroundColor: 'background.default' }}>
			...
			<Container maxWidth='lg' sx={{ py: 4 }}>
				...
				{/* Loading State */}
				{state.loading && <LoadingSpinner message='Fetching weather data...' />}
				...
				{!state.loading && state.currentWeather && (
					<Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
						...
						{/* 5-Day Forecast */}
						{state.forecast && <WeatherForecast forecast={state.forecast} />}
					</Box>
				)}
